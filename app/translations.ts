...
export const translations = {
  en: {
    ...
    finalCta: {
      headline: "Creating an elegant website for a modern brand",
      text: "Let's create a professional website that truly works for your business. Reach out and see how we can help.",
  ...
  ar: {
    ...
    finalCta: {
      headline: "نصنع موقعاً أنيقاً لعلامة تجارية عصرية",
      text: "لننشئ معاً موقعاً احترافياً يعمل حقاً من أجل نشاطك التجاري. تواصل معنا لترى كيف يمكننا المساعدة.",
      ctaPrimary: "تواصل معنا اليوم",
      ctaSecondary: "شاهد أعمالنا",
